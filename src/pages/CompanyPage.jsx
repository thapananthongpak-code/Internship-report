      ...
      <div className="card animate-fade-up delay-200">
        ...
        <div className="card-body">
          <div className="info-grid">
            {[
              { label: 'ชื่อบริษัท (ไทย)',      ph: 'บริษัท ศิริซอฟต์ จำกัด' },
              { label: 'ชื่อบริษัท (อังกฤษ)',   ph: 'Sirisoft Co., Ltd.' },
              { label: 'ประเภทธุรกิจ',           ph: '[กรอกประเภทธุรกิจ]' },
              { label: 'จำนวนพนักงาน',           ph: '[กรอกจำนวนพนักงาน]' },
              { label: 'ที่อยู่',                ph: '[กรอกที่อยู่บริษัท]', full: true },
              { label: 'เบอร์โทรศัพท์',          ph: '[กรอกเบอร์โทร]' },
              { label: 'เว็บไซต์',               ph: 'sirisoft.co.th' },
